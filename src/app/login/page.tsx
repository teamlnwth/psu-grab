...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50/50 flex flex-col items-center justify-center p-4 md:p-6 font-sans">
      <div className="max-w-md w-full bg-white rounded-[32px] shadow-xl border border-slate-100 overflow-hidden p-8 md:p-10 transition-all duration-300 animate-fade-in">
        ...
        {success ? (
          <div className="text-center py-8 flex flex-col items-center justify-center animate-fade-in">
            <div className="w-16 h-16 bg-primary-light text-primary rounded-full flex items-center justify-center mb-6 animate-bounce">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-500 uppercase tracking-wide text-left">อีเมล หรือ รหัสนักศึกษา</label>
              <input
                type="text"
                value={identifier}
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wide text-left">รหัสผ่าน</label>
                <a href="#" className="text-[11px] font-bold text-primary hover:text-primary-hover hover:underline">ลืมรหัสผ่าน?</a>
              </div>
              <input
                type="password"
                value={password}
            ...
            <button
              ...
              className={`w-full bg-primary hover:bg-primary-hover text-white font-extrabold py-4 px-4 rounded-2xl transition duration-300 shadow-md shadow-emerald-100 hover:shadow-lg flex items-center justify-center gap-2 cursor-pointer hover:-translate-y-0.5 active:translate-y-0 ${
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-xs text-slate-400 font-semibold">
            ยังไม่มีบัญชีใช่ไหม?{' '}
            <Link href="/register" className="text-primary hover:text-primary-hover hover:underline font-extrabold">สมัครสมาชิกที่นี่</Link>
          </p>
